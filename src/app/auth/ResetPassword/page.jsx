...
const ResetPassword = () => {
    ...
    const handleSubmit = () =>{router.push('/auth/CheckMail')}
  return (
    <div className="flex flex-col md:flex-row h-screen">
        ...
        <div className="w-full md:w-1/2 p-5 order-1 mb-[50px] md:order-2">
            <h2 className=' text-[#333] ml-[20px] md:ml-[50px] my-[30px] md:my-[50px] text-[30px] md:text-[40px] font-bold'>Check Email</h2>
            ...
            <div className='flex flex-col md:mx-[50px]'>
                ...
                <button onClick={handleSubmit} className='bg-purple-600 mb-2 p-2 rounded-[5px] text-white md:w-1/3'>Send</button>
